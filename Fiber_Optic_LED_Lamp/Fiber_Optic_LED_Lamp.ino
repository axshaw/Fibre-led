...
void wakeUp(){
  ...
  detachInterrupt(digitalPinToInterrupt(wakeUpPin)); //Removes the interrupt from pin D2;
}

void Going_To_Sleep(){
    sleep_enable();//Enabling sleep mode
    attachInterrupt(digitalPinToInterrupt(wakeUpPin), wakeUp, LOW);//attaching a interrupt to pin D2
